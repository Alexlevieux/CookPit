...
public class Cloud {
    ...
    FirebaseAuth mAuth;
    View progressArc;
    public cookPitUser mUser = new cookPitUser();
    ...
    public Cloud(FirebaseAuth Auth, View cloudView, Activity activity) {

        act = activity;
        progressArc = cloudView;
        mAuth = Auth;

        preferences = activity.getApplicationContext().getSharedPreferences("cookPit", Context.MODE_PRIVATE);
    ...
    public void updateUserMenu() {
        displayName = (TextView) act.findViewById(R.id.display_name);
        userRegistration = (TextView) act.findViewById(R.id.user_registration);
        String user = "Chef";
