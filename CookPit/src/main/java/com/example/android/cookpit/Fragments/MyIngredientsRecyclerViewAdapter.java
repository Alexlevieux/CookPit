...
import com.example.android.cookpit.Fragments.dummy.IngredientContent;
...
public class MyIngredientsRecyclerViewAdapter extends RecyclerView.Adapter<MyIngredientsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyIngredientsRecyclerViewAdapter(List<Ingredient> items, IngredientsFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
