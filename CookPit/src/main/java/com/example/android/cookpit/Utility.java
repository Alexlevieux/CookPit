...
import com.example.android.cookpit.data.KitchenDbHelper;
...
public class Utility {
    ...
    public static void testInsertIngredients(Context context) throws IOException {
    ...
    public static void testinsertMEP(Context context) throws IOException {
    ...
    public static void testinsertDMI(Context context) throws IOException {
    ...
    public static Cursor getChildCursorForDishDetailAdapter(Context context, Long mep_id, String[] projection) {
        ...
        Log.v(selection.substring(23, selection.length()), String.valueOf(mep_id));
    ...
    public static void testinsertMI(Context context) throws IOException {
    ...
    public static void testinsertDC(Context context) throws IOException {
