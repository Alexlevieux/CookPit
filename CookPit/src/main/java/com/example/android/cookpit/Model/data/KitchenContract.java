...
public class KitchenContract {
    ...
    public static final class DrawableEntry implements BaseColumns {
        ...
        public static final String COLUMN_DISH_ID = "dish_id";
        public static final String COLUMN_DEFAULT_DRAWABLE = "default_drawable";
        public static final String COLUMN_DATE_TIME_CREATED = "drawable_date_time";
        public static final String COLUMN_PICTURE_TAGS_BLOB = "picture_tags";

        public static Uri BuildDrawableUri(long id) {
            return withAppendedId(CONTENT_URI, id);
        }
