...
public class DishDetailAdapter extends CursorTreeAdapter {
    ...
    public static class ViewHolder {
        ...
        public ViewHolder(View view) {
            nameView = view.findViewById(R.id.list_item_group_textview);
            quantityView = view.findViewById(R.id.list_item_group_textview_quantity);
            childnameView = view.findViewById(R.id.list_item_child_textview);
            childquantityView = view.findViewById(R.id.list_item_child_textview_quantity);
            childMethod = view.findViewById(R.id.child_method_textView);
        }
    }
